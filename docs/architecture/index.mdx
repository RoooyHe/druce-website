---
title: 技术架构
description: 初步报告模块的技术栈、数据流与数据来源策略。
---
...
| 页面 | 内容 |
| :--- | :--- |
| [数据流](/architecture/data-flow) | 从用户输入到报告生成的 6 节点核心流程 |
| [数据来源策略](/architecture/data-sources) | 无金融 API 方案下的 5 类数据来源 |
| [演进路线](/architecture/road-map) | 五层架构细化、核心差距分析与演进路径规划 |

> 相关数据流程参见 [数据流](/architecture/data-flow)。
